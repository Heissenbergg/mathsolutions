...
for($i=0; $i<$lessionsLength;$i++){ ?>
    <div class="tabsCoursesCourseOne" style="margin-top:20px;">
        ...
        <div class="tabsCoursesCourseOneReservation" onclick="move('reservation', '<?php echo $lessions->getName($i); ?>', '<?php echo $lessions->getLessionID($i); ?>')">
    ...
    <div class="tabsCoursesCourseOne tabsCoursesCourseTwo" >
        <div class="tabsCoursesCourseTwoLeft">
            ...
            <div class="tabsCoursesCourseTwoLeftTeachers">
                ...
                <div class="tabsCoursesCourseTwoLeftTeachersAll">
                    <p><?php echo $lessions->getTeachOne($i); ?></p>
                </div>
                <!--
                <div class="tabsCoursesCourseTwoLeftTeachersAll">
        ...
        <div class="tabsCoursesCourseTwoRight">
            ...
            <div class="tabsCoursesCourseTwoRightNameOfCourse">
                <h3><?php echo $lessions->getName($i); ?></h3>
                <p>
                    Na ovaj način prijavljujete samo jednu lekciju.
                </p>
            </div>
            <div class="signUpforThisCourse" onclick="move('reservation', '<?php echo $lessions->getName($i); ?>', '<?php echo $lessions->getLessionID($i); ?>')">
                <a>
                    Rezerviši 
                </a>
            </div>
